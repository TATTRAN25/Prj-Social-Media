        ...
        <div class="row py-4 d-flex align-items-center">
            <div class="col-lg-4 col-md-5 col-sm-12 text-center">
                <div class="position-relative">
                    <img 
                        src="{{ $user->avatar ?? 'http://res.cloudinary.com/du6fyhjnk/image/upload/v1733243488/ecommerce/products/thumbnails/nachroyv9hf1fyocblwt.webp' }}" 
                        alt="user avatar"
            ...
            <div class="col-lg-8 col-md-7 col-sm-12">
                <div class="d-flex flex-column align-items-start gap-2">
                    ...
                    <div class="d-flex align-items-center gap-3 mt-2">
                        <span class="fw-semibold">{{ $posts->count() }} bài viết</span>
                    ...
                    @foreach($posts as $post)
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="position-relative overflow-hidden rounded shadow-sm">
                                @if($post->media && Str::startsWith($post->media_type, 'image'))
                                    <img 
                                        src="{{ asset('storage/' . $post->media) }}" 
                                        alt="post-img"
                                        class="w-100 rounded"
                                        style="aspect-ratio: 1/1; object-fit: cover;">
                                @elseif($post->media && Str::startsWith($post->media_type, 'video'))
                                    <video controls class="w-100 rounded" style="aspect-ratio: 1/1; object-fit: cover;">
                                        <source src="{{ asset('storage/' . $post->media) }}" type="{{ $post->media_type }}">
                                        Trình duyệt của bạn không hỗ trợ video.
                                    </video>
                                @else
                                    <!-- Nếu không có media, có thể hiển thị một placeholder -->
                                    <div class="w-100 bg-secondary text-white d-flex justify-content-center align-items-center" style="aspect-ratio: 1/1;">
